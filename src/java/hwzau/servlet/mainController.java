...
public class mainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action == null || action.equals("") || action.equals("Search Product")) {
                url = "index.jsp";
                ...
                url = "updateStatusAccountsServlet";
            ...
            } else if (action.equals("Search Date Manage Orders")) {
                url = "searchDateManageOrdersSerlvet";
            }
